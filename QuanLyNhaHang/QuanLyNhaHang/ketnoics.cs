...
namespace QuanLyNhaHang
{
    public class ketnoics
    {
        ...
        private void layknoi()
        {
            ...
            con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\USERS\KIM ANH\SOURCE\REPOS\QUANLYNHAHANG\QUANLYNHAHANG\APP_DATA\DATABASE1.MDF;Integrated Security=True");
            con.Open();//mở kết nối
